...
# Copyright: Rytis Petronis (Rytisgit) <petronisrytis@gmail.com>
# Copyright: Vijay <http://t.me/Viiijay1>
# License: GNU GPL, version 3 or later; http://www.gnu.org/copyleft/gpl.html
"""
AnkiPenDown - A feature-rich drawing addon for Anki.

This add-on is an enhancement of Anki-StylusDraw by Rytis Petronis (Rytisgit).
...
__version__ = "1.1" # Bugfix for reviewer refresh method
...
function updatePenCursor(c) {
    const svg = `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.321 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.497z" stroke="${c}" stroke-width="1.8" stroke-linejoin="round"/><path d="m15 5 4 4" stroke="${c}" stroke-width="1.8" stroke-linecap="round"/></svg>`;
